...
const translations = {
    tr: {
        ...
        'p1-detail-title' : 'Proje Detayı',
        'p1-detail-desc' : 'Buraya proje aşamalarını, kullandığın algoritmaları (C++, Java vb.) veya ekran görüntülerini ekleyebilirsin.',
        'p1-detail-desc-more' : 'Örneğin: Bu projede veri yapılarını kullanarak verimli bir arama algoritması geliştirdim.',
    ...
    en: {
        ...
        'p1-detail-title' : 'Project details',
        'p1-detail-desc' : 'Add the project stages, the algorithms you used (C++, Java, etc.), or screenshots here.',
        'p1-detail-desc-more' : 'For example: In this project, I developed an efficient search algorithm using data structures.',
